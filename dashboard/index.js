 ...
 */
    if(bot.guilds.cache.get(config.serverid).members.fetch.get(req.user.id).roles.cache.get(config.server.role.administrator) || bot.guilds.cache.get(config.serverid).members.fetch.get(req.user.id).roles.cache.get(config.server.role.moderator) || req.user.id === "768944616724103170") {
              next();
